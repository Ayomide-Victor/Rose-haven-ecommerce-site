...
const getProducts = async () => {
  try {
    const results = await fetch('/asset/data/products.json');
    ...
    categoriesProducts.insertAdjacentHTML(
      ...
      `<div class="product">
          ...
          <div class="bottom">
            <div class="d-flex">
              <h4>${product.title}</h4>
              <a href="https://wa.me/message/FREQ6O5HZV3AF1" rel="noopener noreferrer" target="_blank"  class="btn cart-btn">Order</a>
            </div>
            <div class="d-flex">
              <div class="price">$${product.price}</div>
              <div class="rating">
